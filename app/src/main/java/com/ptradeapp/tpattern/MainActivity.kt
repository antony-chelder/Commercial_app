...
import com.ptradeapp.tpattern.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        videoPlayer()
        binding.ewwef.setOnClickListener {
            ...
            val intent = Intent(this, RegPattern::class.java)
    ...
    private fun videoPlayer() {
        val mediaItem: MediaItem = MediaItem.fromUri("http://video.pr0gram1.xyz/video/patuern/patuern.m3u8")
        binding.videoView.player = player
